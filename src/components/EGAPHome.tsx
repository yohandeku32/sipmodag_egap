...
export default function EGAPHome({ onBack, onLoginOPD }: EGAPHomeProps) {
  return (
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.article
                  ...
                  className="group rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-blue-200 hover:shadow-lg"
                >
                  ...
                  <div className="mt-5 flex items-center gap-2 text-xs font-extrabold uppercase tracking-wider text-slate-400">
                    <span>Konten E-GAP</span>
